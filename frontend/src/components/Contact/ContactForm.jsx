  ...
  return (
    <div className="w-full max-w-md mx-auto p-8 bg-[#0a0a0a] border border-white/10 rounded-2xl shadow-[0_0_40px_rgba(0,0,0,0.5)]">
      <form onSubmit={handleSubmit} className="flex flex-col gap-5">
        ...
        {status === "success" && (
          <div className="p-4 mt-2 bg-green-500/20 border border-green-500/50 rounded-xl text-green-400 text-center font-medium">
            Wiadomość wysłana! Potwierdź pierwszą wysyłkę w mailu aktywacyjnym od FormSubmit.
          </div>
        )}
