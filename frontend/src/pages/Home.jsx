  ...
  return (
    <div className="min-h-screen text-text relative">
      ...
      <div className="fixed inset-0 z-0 pointer-events-none">
        ...
        {/* Górny żółty gradient */}
        <div className="absolute top-[-10%] left-1/4 w-[600px] h-[600px] bg-primary/10 rounded-full blur-[140px]"></div>
        {/* Dolny żółty gradient */}
              ...
              <div className="text-left space-y-8 animate-in fade-in slide-in-from-left-8 duration-1000">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {[
                    ...
                    <div key={idx} className="flex items-center gap-3 bg-surface/50 p-4 rounded-xl border border-white/5 backdrop-blur-md">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-4">
                  <button onClick={handleConsultationClick} className="group px-8 py-4 bg-primary text-black font-black text-lg rounded-xl hover:shadow-[0_0_40px_rgba(255,210,0,0.3)] transition-all flex items-center justify-center gap-3">
                    Rezerwuj termin
        ...
        <section className="py-20 lg:py-32">
          <div className="container max-w-[1100px] mx-auto px-6">
            <div className="text-center mb-16">
              <h2 className="text-4xl md:text-5xl font-bold mb-6 text-white">Dlaczego <span className="text-primary">Autotest?</span></h2>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
              {mockData.features.map((feature, idx) => {
                ...
                return (
                  <div key={idx} className="bg-surface/50 backdrop-blur-md p-8 rounded-3xl border border-white/5 hover:border-primary/50 transition-colors group shadow-xl">
