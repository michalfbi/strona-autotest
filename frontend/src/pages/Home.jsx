...
export const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#050505]">
      <section className="relative pt-20 pb-16 lg:pt-28 lg:pb-24 overflow-hidden border-b border-white/5 text-white">
        <div className="absolute inset-0 bg-[linear-gradient(to_right,#ffffff05_1px,transparent_1px),linear-gradient(to_bottom,#ffffff05_1px,transparent_1px)] bg-[size:32px_32px]"></div>
        <div className="container relative z-10 max-w-[1100px] mx-auto px-4">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 items-center">
            <div className="text-left space-y-6">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {["Skanowanie lakieru", "Diagnostyka pokładowa", "Weryfikacja VIN", "Testy drogowe"].map((item) => (
                  <div key={item} className="flex items-center gap-3 bg-white/5 p-3.5 rounded-lg border border-white/5">
